...
{
    "key_id": <>, # Ідентифікатор ключа, який має право підпису документів у податковому кабінеті
    "public_key": <string> # Ідентифікатор ключа суб’єкта. Якщо потрібно Якщо потрібно надіслати ідентифікатор зазначеного ключа, параметр необхідно прибрати
}
...
Формат JSON запиту:
{
    ...
    "values": [
        ...
        "T1RXXXXG6": <integer>, # код за КОАТУУ або
...
T1RXXXXG6 або T1RXXXXG6S «Територія територіальної громади, де знаходиться об’єкт оподаткування» заповнюється відповідно до Класифікатора об’єктів адміністративно-територіального устрою (КОАТУУ), що розміщений на офіційному вебсайті Державної служби статистики України або відповідно до Кодифікатора адміністративно-територіальних одиниць та територій територіальних громад (КАТОТТГ), що розміщений на офіційному вебсайті Міністерства розвитку громад та територій України.
